...
using AuthenticationResponse = net.openstack.Providers.Rackspace.Objects.Response.v3.AuthenticationResponse;
using UserAccess = net.openstack.Core.Domain.v3.UserAccess;
using IdentityToken = net.openstack.Core.Domain.v3.IdentityToken;
using UserImpersonationResponse = net.openstack.Providers.Rackspace.Objects.Response.v3.UserImpersonationResponse;
...
namespace net.openstack.Providers.Rackspace.v3
{
    ...
    public class CloudIdentityProvider : ProviderBase<IIdentityProvider>, IExtendedCloudIdentityProvider, Core.Providers.v3.IIdentityService
    {
        /// <summary>
        ...
        {
            _userAccessCache = tokenCache ?? Core.Caching.v3.UserAccessCache.Instance;
        ...
        /// <inheritdoc/>
        public virtual Core.Domain.v3.IdentityToken GetToken(CloudIdentity identity, bool forceCacheRefresh = false)
        {
            CheckIdentity(identity);
        ...
        /// <inheritdoc/>
        public virtual Task<net.openstack.Core.Domain.v3.IdentityToken> GetTokenAsync(CloudIdentity identity, CancellationToken cancellationToken)
        {
        ...
        protected virtual UserAccess Impersonate(RackspaceImpersonationIdentity identity, bool forceCacheRefresh)
        {
            ...
            var impToken = TokenCache.Get(string.Format("{0}:{1}/imp/{2}/{3}", UrlBase, identity.Username, identity.UserToImpersonate.Domain == null ? "none" : identity.UserToImpersonate.Domain.Name, identity.UserToImpersonate.Username), () =>
            {
                ...
                return new UserAccess(userAccess.Token);
            }, forceCacheRefresh);
        ...
        async Task<string> IAuthenticationProvider.GetEndpoint(IServiceType serviceType, string region, bool useInternalUrl, CancellationToken cancellationToken)
        {
            ...
            return OpenStack.Core.v3.LegacyAuthenticationProviderHelper.GetEndpoint(serviceTypeKey, userAccess, DefaultIdentity, requestedRegion, useInternalUrl);
        }
