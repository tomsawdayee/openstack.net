...
namespace net.openstack.Providers.Rackspace.v3
{
    ...
    public interface IExtendedCloudIdentityProvider : Core.Providers.v3.IIdentityProvider
    {
        /// <summary>
        /// Lists all roles.
        ...
        /// <see cref="net.openstack.Providers.Rackspace.v3.CloudIdentityProvider(CloudIdentity)"/>.</para>
