...
namespace net.openstack.Core.Providers.v3
{
    ...
    public interface IIdentityProvider : IAuthenticationProvider
    {
        ...
        Domain.v3.UserAccess Authenticate(CloudIdentity identity = null);
        ...
        Domain.v3.UserAccess ValidateToken(string token, string tenantId = null, CloudIdentity identity = null);
        ...
        /// <exception cref="ResponseException">If the authentication request failed.</exception>
        /// <seealso href="http://docs.openstack.org/api/openstack-identity-service/2.0/content/POST_authenticate_v2.0_tokens_.html">Authenticate (OpenStack Identity Service API v2.0 Reference)</seealso>
        Domain.v3.IdentityToken GetToken(CloudIdentity identity = null, bool forceCacheRefresh = false);
        ...
        /// <exception cref="ResponseException">If the REST API request failed.</exception>
        /// <seealso href="http://docs.openstack.org/api/openstack-identity-service/2.0/content/POST_authenticate_v2.0_tokens_.html">Authenticate (OpenStack Identity Service API v2.0 Reference)</seealso>
        Domain.v3.UserAccess GetUserAccess(CloudIdentity identity = null, bool forceCacheRefresh = false);
