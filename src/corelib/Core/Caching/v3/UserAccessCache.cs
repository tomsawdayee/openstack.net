...
namespace net.openstack.Core.Caching.v3
{
    /// <summary>
    /// Provides a thread-safe cache of <see cref="Domain.v3.UserAccess"/> objects. A default shared
    ...
    public class UserAccessCache : ICache<UserAccess>
    {
        ...
        /// (see <see cref="Domain.IdentityToken.IsExpired"/>).</item>
        /// </list>
        ///
        ...
        {
            var token = userAccess != null ? userAccess.Token : null;
